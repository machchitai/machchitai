...
import PaginationComp from '../Module/TestMaterialUI/PaginationComp';
...
const TrangTestMaterialUI = () => {
    ...
    return (
        <div>
            ...
            {/* {
                mang_data[cur_page].map(title => {
                    <div>{title}</div>
                })
            }
            <PaginationComp count={mang_data.length} onChange={handleChange} ></PaginationComp> */}
