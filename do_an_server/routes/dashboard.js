...
router.get('/get-last-month', (req,res,next) => {
    ...
    var number_of_day = new Date(current_year, last_month, 0).getDate();
...
router.get('/data-last-month', (req,res,next) => {
    var last_month = (new Date()).getMonth();
    var current_year =  (new Date()).getFullYear();
...
router.get('/data-employee', (req,res,next) => {
    var number_of_employee = 10;

    var array_employee = [];

    for (var i = 0; i < number_of_employee; i++){
        var employee = {
