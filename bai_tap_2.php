            ...
            <form action="" method="POST" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10 col-sm-10 col-md-10 col-lg-10">
                            ...
                            <input type="text" name="co_chu" id="input" class="form-control" value="<?php if(isset($_POST["co_chu"])) echo $_POST["co_chu"] ?>">
                    ...
                    <div style="height: 500px; display: flex; text-align: center; background: linear-gradient(180deg, #<?php echo $_POST['mau_nen_1']; ?>, #<?php echo $_POST['mau_nen_2']; ?>); color: #<?php echo $_POST['mau_chu']; ?>; font-size: <?php echo $_POST['co_chu']?>px;">
